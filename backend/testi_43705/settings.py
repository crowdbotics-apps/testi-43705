"""
Django settings for testi_43705 project.
...
WSGI_APPLICATION = 'testi_43705.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testi_43705 API",
    "DESCRIPTION": "API documentation for testi_43705 App",
    "VERSION": "v1",
}
